    ...
    return (
      <Grid>
        ...
        <Grid.Column width={6}>
          ...
          {this.state.isOpen && <EventForm handleCancel={this.handleCancel} createEvent={this.handleCreateEvent} selectedEvent={selectedEvent} updateEvent={this.handleUpdateEvent} />}
        </Grid.Column>
      </Grid>
    )
  }
